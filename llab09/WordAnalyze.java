...
public class WordAnalyze {
    ...
    private final String[] keyWord = {"int","return","main","const","getint","getch","putint","putch","if","else","while"
            ,"break","continue","void","getarray","putarray"};
    ...
    public WordAnalyze(){
        ...
        keyWordList.add(Tokens.Getarray);
        keyWordList.add(Tokens.Putarray);
    }
    //判断是否是字母
